...
RegisterNetEvent('scoreboard:accessGranted')
AddEventHandler('scoreboard:accessGranted', function()
    accessGranted = true
end)
...
local function DrawPlayerList()
    ...
    --Top bar
    DrawRect(0.896, 0.20, 0.16, 0.03, 0, 0, 0, 220)
    ...
    SetTextEntry("STRING")
    AddTextComponentString("Citoyens : ".. #players)
    DrawText(0.82, 0.185)
    ...
    for k, v in pairs(players) do
        ...
        --Row BG
        DrawRect(0.896, 0.202 + (k * 0.025), 0.16, 0.025, r, g, b, 220)
        ...
        if Settings["VoiceIndicator"] then
            ...
            DrawSprite("mplobby", "mp_charcard_stats_icons9", 0.966, 0.202 + (k * 0.025), 0.0096, 0.016, 0, 255, 255, 255, transparency)
        end
        ...
        if Settings["WantedStars"] then
            ...
            for i = 1, 5 do
                ...
                DrawSprite("mpleaderboard", "leaderboard_star_icon", 0.196 - (i * 0.010), 0.019 + (k * 0.025), 0.0175, 0.0255, 0, 255, 255, 255, transparency)
            end
        end
    end
end
