local lsc = {
    ...
    selectedbutton = 0,
    locations = {
        [1] = { locked = false, outside = { x = -221.9080, y = -1330.0468, z = 30.8903, heading = 89.347 }, inside = { x = -221.9080, y = -1330.0468, z = 30.8903, heading = 89.347 } },
    ...
    menu = {
        ...
        ["primarymetallic"] = {
            ...
            buttons = {
                ...
                { name = "Graphite", costs = 1320, colorindex = 1, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Anhracite Black", costs = 1380, colorindex = 11, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Black Steel", costs = 1380, colorindex = 2, description = "", centre = 0, font = 0, scale = 0.4 },
                ...
                { name = "Pfsiter Pink", costs = 13750, colorindex = 137, description = "", centre = 0, font = 0, scale = 0.4 },
                ...
                { name = "Dark Green", costs = 1450, colorindex = 49, description = "", centre = 0, font = 0, scale = 0.4 },
        ...
        ["secondarymatte"] = {
            ...
            buttons = {
                ...
                { name = "Gray", colorindex = 13, costs = 2050, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Light Gray", colorindex = 14, costs = 2000, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Ice White", colorindex = 131, costs = 2210, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Blue", colorindex = 83, costs = 14250, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Dark Blue", colorindex = 82, costs = 2150, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Midnight Blue", colorindex = 84, costs = 10000, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Midnight Purple", colorindex = 149, costs = 13750, description = "", centre = 0, font = 0, scale = 0.4 },
        ...
        ["windows"] = {
            ...
            buttons = {
                ...
                { name = "Pure Black", tint = 1, costs = 6000, description = "", centre = 0, font = 0, scale = 0.4 },
                ...
                { name = "Limo", tint = 4, costs = 5000, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Green", tint = 5, costs = 8000, description = "", centre = 0, font = 0, scale = 0.4 }
            }
        },
        ["wheelaccessories"] = {
        ...
        ["primaryclassic"] = {
            ...
            buttons = {
                ...
                { name = "Dark Green", costs = 870, colorindex = 49, description = "", centre = 0, font = 0, scale = 0.4 },
                ...
                { name = "Galaxy Blue", costs = 1010, colorindex = 61, description = "", centre = 0, font = 0, scale = 0.4 },
        ...
        ["secondaryclassic"] = {
            ...
            buttons = {
                { name = "Black", costs = 840, colorindex = 0, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Carbon Black", costs = 810, colorindex = 147, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Graphite", costs = 790, colorindex = 1, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Anhracite Black", costs = 830, colorindex = 11, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Black Steel", costs = 860, colorindex = 2, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Dark Steel", costs = 780, colorindex = 3, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Silver", costs = 820, colorindex = 4, description = "", centre = 0, font = 0, scale = 0.4 },
                ...
                { name = "Lava Red", costs = 11600, colorindex = 150, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Blaze Red", costs = 3800, colorindex = 30, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Grace Red", costs = 850, colorindex = 31, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Garnet Red", costs = 950, colorindex = 32, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Sunset Red", costs = 10600, colorindex = 33, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Cabernet Red", costs = 9600, colorindex = 34, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Wine Red", costs = 10400, colorindex = 143, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Candy Red", costs = 12150, colorindex = 35, description = "", centre = 0, font = 0, scale = 0.4 },
                ...
                { name = "Chocolate Brown", costs = 9050, colorindex = 96, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Bison Brown", costs = 8000, colorindex = 101, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Creek Brown", costs = 780, colorindex = 95, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Feltzer Brown", costs = 810, colorindex = 94, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Maple Brown", costs = 850, colorindex = 97, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Beechwood Brown", costs = 900, colorindex = 103, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Sienna Brown", costs = 920, colorindex = 104, description = "", centre = 0, font = 0, scale = 0.4 },
        ...
        ["suspension"] = {
            ...
            buttons = {
                ...
                { name = "Competition Suspension", mod = 3, modtype = 15, costs = 4400, description = "", centre = 0, font = 0, scale = 0.4 }
            }
        },
        ["transmission"] = {
            title = "transmissions",
            ...
            buttons = {
                ...
                { name = "Street Transmission", mod = false, modtype = 13, costs = 5900, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Sports Transmission", mod = 1, modtype = 13, costs = 6500, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Race Transmission", mod = 2, modtype = 13, costs = 8000, description = "", centre = 0, font = 0, scale = 0.4 }
            }
        },
        ["turbo"] = {
            title = "turbo",
            ...
            buttons = {
                ...
                { name = "Turbo Tuning", mod = true, modtype = 18, costs = 30000, description = "", centre = 0, font = 0, scale = 0.4 }
            }
        },
        ["wheels"] = {
            title = "wheels",
        ...
        ["headlights"] = {
            ...
            buttons = {
                ...
                { name = "Xenon Lights", mod = true, modtype = 22, costs = 3000, description = "", centre = 0, font = 0, scale = 0.4 }
            }
        },
        ["plate"] = {
            title = "plates",
        ...
        ["repair"] = {
            ...
            name = "repair",
            buttons = {
                { name = "Repair vehicle", description = "Full body repair and engine service.", costs = 50, centre = 0, font = 0, scale = 0.4 }
            }
        },
        ["armor"] = {
            title = "armor",
            ...
            buttons = {
                ...
                { name = "Armor Upgrade 20%", modtype = 16, mod = false, costs = 4500, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Armor Upgrade 40%", modtype = 16, mod = 1, costs = 7500, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Armor Upgrade 60%", modtype = 16, mod = 2, costs = 12000, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Armor Upgrade 80%", modtype = 16, mod = 3, costs = 21000, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Armor Upgrade 100%", modtype = 16, mod = 4, costs = 30000, description = "", centre = 0, font = 0, scale = 0.4 }
            }
        },
        ["brakes"] = {
            title = "brakes",
            ...
            buttons = {
                ...
                { name = "Street Brakes", modtype = 12, mod = false, costs = 4000, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Sport Brakes", modtype = 12, mod = 1, costs = 5400, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Race Brakes", modtype = 12, mod = 2, costs = 7000, description = "", centre = 0, font = 0, scale = 0.4 }
            }
        },
        ["engine"] = {
            title = "engine tunes",
            name = "engine",
            buttons = {
                { name = "EMS Upgrade, Level 1", modtype = 11, mod = -1, costs = 1800, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "EMS Upgrade, Level 2", modtype = 11, mod = false, costs = 2500, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "EMS Upgrade, Level 3", modtype = 11, mod = 1, costs = 3600, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "EMS Upgrade, Level 4", modtype = 11, mod = 2, costs = 6700, description = "", centre = 0, font = 0, scale = 0.4 }
            }
        },
        ["horn"] = {
            title = "horns",
            ...
            buttons = {
                ...
                { name = "Truck Horn", modtype = 14, mod = false, costs = 2000, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Police Horn", modtype = 14, mod = 1, costs = 3000, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Clown Horn", modtype = 14, mod = 2, costs = 5000, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Musical Horn 1", modtype = 14, mod = 3, costs = 10000, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Musical Horn 2", modtype = 14, mod = 4, costs = 12500, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Musical Horn 3", modtype = 14, mod = 5, costs = 15000, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Musical Horn 4", modtype = 14, mod = 6, costs = 17500, description = "", centre = 0, font = 0, scale = 0.4 },
                { name = "Musical Horn 5", modtype = 14, mod = 7, costs = 25000, description = "", centre = 0, font = 0, scale = 0.4 },
                    ...
                    for i, pos in ipairs(lsc.locations) do
                        ...
                        if GetDistanceBetweenCoords(outside.x, outside.y, outside.z, GetEntityCoords(ped)) <= f(5) then
                            if pos.locked == false then
                                drawTxt("Appuyez sur ~b~ENTER~w~ pour rentrer a ~b~Los Santos Customs ", 4, 1, 0.5, 0.8, 1.0, 255, 255, 255, 255)
                                if IsControlJustPressed(1, 201) then
                                    if accessGranted then
                                        ...
                                        TriggerEvent('showNotify', "Seuls les ~y~dépanneurs~w~ en service ont ~r~accès~w~ à l\'atelier.")
                                    end
                                end
                            else
                                drawTxt("~r~Bloqué, merci d'attendre", 4, 1, 0.5, 0.8, 1.0, 255, 255, 255, 255)
                            end
                        end
                    end
                end
...
RegisterNetEvent('lscustoms:grantAccess')
AddEventHandler('lscustoms:grantAccess', function(value)
    accessGranted = value
end)