...
local id = Citizen.InvokeNative(0xBFEFE3321A3F5015,
    GetPlayerPed(-1),
    "Name2",
    false,
    false,
...
N_0x63bb75abedc1f6a0(id, 2, true)
N_0xd48fe545cd46f857(id, 2, 255)
Citizen.InvokeNative(0x3158C77A7E888AB4,
    id,
    50
)
...
AddEventHandler('es_admin:viewname', function()
    for id = 0, 64 do
