...
function MySQL.Async.execute(query, params, func, transaction)
    ...
    clr.Brouznouf.FiveM.Async.ExecuteCallback(executeTask, MySQL.Async.wrapQuery(callback,
        connection,
        Command.CommandText,
...
function MySQL.Async.fetchAll(query, params, func, transaction)
    ...
    clr.Brouznouf.FiveM.Async.ExecuteReaderCallback(executeReaderTask, MySQL.Async.wrapQuery(callback,
        connection,
        Command.CommandText,
...
function MySQL.Async.fetchScalar(query, params, func, transaction)
    ...
    clr.Brouznouf.FiveM.Async.ExecuteScalarCallback(executeScalarTask, MySQL.Async.wrapQuery(callback,
        connection,
        Command.CommandText,
        MySQL.Utils.ConvertObject))
end
...
function MySQL.Async.beginTransaction(func)
    ...
    clr.Brouznouf.FiveM.Async.BeginTransactionCallback(beginTransactionTask, MySQL.Async.wrapQuery(callback,
        nil,
        'BEGIN TRANSACTION'))
end
...
function MySQL.Async.commitTransaction(transaction, func)
    ...
    clr.Brouznouf.FiveM.Async.CommitTransactionCallback(commitTransactionTrask, MySQL.Async.wrapQuery(callback,
...
function MySQL.Async.rollbackTransaction(transaction, func)
    ...
    clr.Brouznouf.FiveM.Async.RollbackTransactionCallback(rollbackTransactionTask, MySQL.Async.wrapQuery(callback,
        transaction.Connection,
        'ROLLBACK'))
end
