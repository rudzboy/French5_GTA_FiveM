...
AddEventHandler("mm:firstspawn", function()
    TriggerServerEvent("mm:otherspawn")
    TriggerEvent("vehshop:addFreeVehicle")
end)
...
function Main()
    DisplayHelpText("~INPUT_CELLPHONE_UP~ ~INPUT_CELLPHONE_DOWN~ pour ~y~naviguer~w~ et ~y~Entrée~w~ pour ~r~choisir~w~.")
    --Notify("Appuyez sur ~r~E ~w~pour ~g~ouvrir~w~/~r~fermer~w~!")
    Notify("~w~Appuyez sur ~g~F ~w~pour ~g~sauvegarder~w~ !")
    options.menu_title = "Boutique"
    options.menu_subtitle = "Categories"
    ClearMenu()
    Menu.addButton("Homme", "Customisation", nil)
    Menu.addButton("Femme", "FCustomisation", nil)
    Menu.addButton("Modèle", "MPMenu", nil)
    --[[
...
function MPMenu()
    --DisplayHelpText("Use ~INPUT_CELLPHONE_UP~ ~INPUT_CELLPHONE_DOWN~ to ~y~move~w~ and ~y~Enter~w~ to ~r~select")
    options.menu_subtitle = "Genre"
    ClearMenu()
    Menu.previous = "Main"
    Menu.addButton("Homme", "savempmodel", freemode_models[Menu.buttonCount + 1])
    Menu.addButton("Femme", "savempmodel", freemode_models[Menu.buttonCount + 1])
...
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
local emplacement = {
    { name = "Boutique de vêtements", id = 73, x = 1932.76989746094, y = 3727.73510742188, z = 32.8444557189941 },
    { name = "Boutique de vêtements", id = 73, x = 1693.26, y = 4822.27, z = 42.06 },
    { name = "Boutique de vêtements", id = 73, x = 125.83, y = -223.16, z = 54.55 },
    { name = "Boutique de vêtements", id = 73, x = -710.16, y = -153.26, z = 37.41 },
    { name = "Boutique de vêtements", id = 73, x = -821.69, y = -1073.90, z = 11.32 },
    { name = "Boutique de vêtements", id = 73, x = -1192.81, y = -768.24, z = 17.31 },
    { name = "Boutique de vêtements", id = 73, x = 4.25, y = 6512.88, z = 31.87 },
    { name = "Boutique de vêtements", id = 73, x = 425.471, y = -806.164, z = 29.4911 },
    { name = "Boutique de vêtements", id = 73, x = 615.554, y = 2764.55, z = 42.0882 },
    { name = "Boutique de vêtements", id = 73, x = -1099.18, y = 2710.53, z = 19.1079 },
    { name = "Boutique de vêtements", id = 73, x = -3172.1, y = 1042.98, z = 20.8632 },
    { name = "Boutique de vêtements", id = 73, x = 77.0791, y = -1391.41, z = 29.3762 },
    { name = "Boutique de vêtements", id = 73, x = -161.849, y = -303.612, z = 39.7334 },
}
incircle = false
    ...
    while true do
        ...
        for k, v in ipairs(emplacement) do
            if (Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 15.0) then
                DrawMarker(1, v.x, v.y, v.z - 1, 0, 0, 0, 0, 0, 0, 1.0001, 1.0001, 1.5001, 255, 200, 0, 165, 0, 0, 0, 0)
                if (Vdist(pos.x, pos.y, pos.z, v.x, v.y, v.z) < 1.0) then
                    if (incircle == false) then
                        DisplayHelpText("Appuyez sur ~INPUT_CONTEXT~ pour ~b~changer~w~ votre ~y~apparence~w~.")
                    end
                    incircle = true
                    ...
                    if (IsControlJustReleased(1, 23)) then
                        if mp_check then
                            ...
                            Notify("~g~Apparence sauvegardée.")
