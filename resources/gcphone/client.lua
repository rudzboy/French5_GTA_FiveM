...
local KeyOpenClose = 303 --INPUT_REPLAY_SCREENSHOT--
...
RegisterNetEvent("gcPhone:closePhone")
AddEventHandler("gcPhone:closePhone", function()
  menuIsOpen = false
...
RegisterNUICallback('callEvent', function(data, cb)
  if data.eventName == "phone:sendMessage" then
    TriggerServerEvent(data.eventName, data.type, data.receiver)
  else
